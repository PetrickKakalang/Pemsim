		...
		<div class="row mt-3 fadeInUp animated">
			<div class="col-md-8 mb-3">
				<div class="card border-dark">
					<div class="card-header bg-light text-dark text-center font-weight-bold"><i class="fas fa-fw fa-calculator"></i>Aplikasi Memprediksi Penjualan Dengan Metode MonteCarlo</div>
					<div class="card-body">
